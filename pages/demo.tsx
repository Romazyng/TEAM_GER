...
export default function DemoPage() {
  ...
  const handleDownload = async () => {
    if (recordedChunks.length) {
      ...
      const question =
        selected.name === "Our team members"
          ? `Tell me about yourself. Why don${`’`}t you walk me through your resume?`
          : selectedInterviewer.name === "Eugenue"
          ? "What is a Hash Table, and what is the average case and worst case time for each of its operations?"
          : selectedInterviewer.name === "Rafik"
                ...
                {step === 1 &&
                  (selected.name === "Our team members" ? (
                    ...
                    >
                      ...
                      <li className="list-none relative flex items-stretch">
                        <div className="group relative ">
                          <div className="relative mb-2 flex max-h-[100px] w-full items-start rounded-lg p-2 font-medium transition duration-100">
                            <div className="absolute inset-0 rounded-lg ring-1 ring-inset ring-zinc-900/[7.5%] group-hover:ring-zinc-900/10"></div>
